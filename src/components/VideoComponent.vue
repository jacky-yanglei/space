<template>
    <div>
        ...
        :visible.sync="$store.state.playVideo"
        ...
        <div class="page">
            <div class="context">
                <div class="content" v-if="$store.state.videoEvent">
                    <video 
                    width="100%"
                    height="100%"
                    @ended="end"
                    ...
                    controls
                    >
                     <source :src="$store.state.videoEvent?$store.state.videoEvent.data:''" type="video/mp4" />
                    </video>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
      ...
      close() {
        this.$store.state.videoEvent = null;
      }
    }
}
</script>
